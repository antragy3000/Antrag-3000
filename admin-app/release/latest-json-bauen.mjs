// Erzeugt admin-app/release/latest.json aus den signierten Build-Artefakten
// der ADMIN-App. Gleiches Prinzip wie release/latest-json-bauen.mjs der
// Haupt-App, nur mit dem Admin-Unterordner der NAS.
//
...
console.log(`latest.json geschrieben (Admin-Version ${version}).`);
console.log("");
console.log("Jetzt auf die NAS in den Ordner  updates/admin/  hochladen:");
console.log(`  1. ${setup}`);
console.log(`  2. admin-app/release/latest.json`);
